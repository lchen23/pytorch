...
\end{Verbatim}
    ...
    ----> 1 import torch
        ...
        C:\textbackslash{}ProgramData\textbackslash{}Anaconda3\textbackslash{}envs\textbackslash{}fastai-cpu\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}torch\textbackslash{}\_\_init\_\_.py in <module>()
         76     pass
         77 
    ---> 78 from torch.\_C import *
         79 
         80 \_\_all\_\_ += [name for name in dir(\_C)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{k+kn}{import} \PY{n+nn}{psutil}\PY{o}{,} \PY{n+nn}{os}
        \PY{n}{p} \PY{o}{=} \PY{n}{psutil}\PY{o}{.}\PY{n}{Process}\PY{p}{(} \PY{n}{os}\PY{o}{.}\PY{n}{getpid}\PY{p}{(}\PY{p}{)} \PY{p}{)}
        \PY{k}{for} \PY{n}{dll} \PY{o+ow}{in} \PY{n}{p}\PY{o}{.}\PY{n}{memory\PYZus{}maps}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{n+nb}{print}\PY{p}{(}\PY{n}{dll}\PY{o}{.}\PY{n}{path}\PY{p}{)}
\end{Verbatim}
...
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}rpcrt4.dll
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}msctf.dll
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}setupapi.dll
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}ole32.dll
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}oleaut32.dll
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}msvcrt.dll
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}nsi.dll
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}ws2\_32.dll
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}usp10.dll
C:\textbackslash{}Windows\textbackslash{}System32\textbackslash{}apisetschema.dll

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} from fastai.imports import *}
        \PY{c+c1}{\PYZsh{} from fastai.transforms import *}
        \PY{c+c1}{\PYZsh{} from fastai.conv\PYZus{}learner import *}
        \PY{c+c1}{\PYZsh{} from fastai.model import *}
        \PY{c+c1}{\PYZsh{} from fastai.dataset import *}
        \PY{c+c1}{\PYZsh{} from fastai.sgdr import *}
        \PY{c+c1}{\PYZsh{} from fastai.plots import *}
\end{Verbatim}
